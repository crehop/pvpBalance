...
public class Damage
{
	...
	public static int calcArmor(PVPPlayer pvpPlayer)
	{
		int armor = 500;
		for(ItemStack i:pvpPlayer.getPlayer().getInventory().getArmorContents())
		{
			...
			switch(check)
			{
				...
				//leather helm
				case 298: 
					ItemStack helmet = pvpPlayer.getPlayer().getInventory().getHelmet();
				...
				//leather chest
				case 299: 
					ItemStack chestplate = pvpPlayer.getPlayer().getInventory().getChestplate();
				...
				//leather leggings
				case 300:
					ItemStack leggings = pvpPlayer.getPlayer().getInventory().getLeggings();
				...
				//leather boots
				case 301: 
					ItemStack boots = pvpPlayer.getPlayer().getInventory().getBoots();
